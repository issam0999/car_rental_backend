...
class CenterParameterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('center_parameters')->insert([
            ...
            ['center_id' => 1, 'key' => 'vat_reg_attachment', 'name' => 'VAT Reg No', 'value' => null, 'type' => 'file', 'group' => 'vat', 'required' => 0, 'description' => null, 'subscription' => 0],
            ['center_id' => 1, 'key' => 'trn_number', 'name' => 'TRN No', 'value' => null, 'type' => 'text', 'group' => 'vat', 'required' => 0, 'description' => null, 'subscription' => 0],
            ['center_id' => 1, 'key' => 'trn_attachment', 'name' => 'TRN No', 'value' => null, 'type' => 'file', 'group' => 'vat', 'required' => 0, 'description' => null, 'subscription' => 0],
